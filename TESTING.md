...
| `stats_kurtosis.test` | Both kurtosis functions; spec example {10,12,15,18,20} (β₂≈1.5268, g₂≈−1.8927); n=3 (kurtosis defined, excess NULL); all-NULL; all-equal; single row; GROUP BY |
